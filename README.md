...
|------------------------------------------------------------------------------------------|--------------------------------|--------------------------------|
| Julia 1.X --- **No release yet**                                                         |  **In progress**               |    **In development**          |                                                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Julia 0.7 --- **Release exists**                                                         |  **In progress**               |    [![Tests](https://github.com/rob-luke/EEG.jl/actions/workflows/runtests.yml/badge.svg)](https://github.com/rob-luke/EEG.jl/actions/workflows/runtests.yml)   | 
